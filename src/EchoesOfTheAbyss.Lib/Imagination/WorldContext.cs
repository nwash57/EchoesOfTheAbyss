...
public class WorldContext
{
	...
	public EchoesOfTheAbyss.Lib.Player.Player Player { get; set; } = new();

	public EchoesOfTheAbyss.Lib.Equipment.Equipment Equipment { get; set; } = new();

	public EchoesOfTheAbyss.Lib.Location.Location CurrentLocation { get; set; } = new();
