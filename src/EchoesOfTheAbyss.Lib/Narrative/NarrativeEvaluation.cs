...
public class NarrativeEvaluation
{
    ...
    public string PlotAlignment   { get; set; } = "on_track";
    ...
    public static string JsonSchema =>
        """
        {
            ...
            "properties": {
                ...
                "plotAlignment": {
                    "type": "string",
                    "enum": ["on_track", "drifting", "diverged"],
                    "description": "How aligned the player's action is with the current plot objective. 'on_track' = progressing toward it, 'drifting' = exploring sideways but recoverable, 'diverged' = actively moved away from the plot."
                }
            },
            "required": ["updateLocation", "updatePlayer", "updateEquipment", "healthDelta", "logEntry", "plotAlignment"]
        }
        """;
}
